...
```bash
TESTLINK_WRITE_ENABLED=true npx -y testlink-mcp@1.0.4
```
...
Future image name after approval and publication: `ghcr.io/eason0in/testlink-mcp:1.0.4`.

## Release policy

Version 1.0.4 is release-ready but publication remains an explicit action. The
